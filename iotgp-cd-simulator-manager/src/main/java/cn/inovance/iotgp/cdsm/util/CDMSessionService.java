...
public class CDMSessionService {
	/*** 创建全局的唯一redisTemplate实例. */
	public static RedisTemplate redisTemplate = (RedisTemplate) ApplicationUtil
			.getBean("redisTemplate");
	/** 本类采用单实例模式. */
	private static CDMSessionService instance = null;
	 ...
	 */
	public static CDMSessionService getInstance() {
		if (instance == null) {
			instance = new CDMSessionService();
		}
		return instance;
	}
	...
	public static void main(String[] args) {
		CDMSessionService.getInstance();
	}

	public Map<String, SimulateDeviceInfo> getDeviceLoginInfos(String clientCode) {
		Map enrtys = hashValueOper.entries(clientCode);
		return enrtys;
	}
