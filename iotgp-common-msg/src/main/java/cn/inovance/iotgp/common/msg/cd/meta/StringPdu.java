...
public class StringPdu extends PDU {
	...
	public StringPdu(String value) {
		this.dataLenth = (value != null) ? value.length() : 0;
		this.value = value;
	}

	public StringPdu(int length, String value) {
		this.dataLenth = length;
		this.value = value;
	}

	public StringPdu(int length, int startIndex, byte[] data)
