 ...
 *
 */
public class ProcedureFileUploadCompleteReq extends AbstractReqPackage {
	/** SessionID */
	...
	public ProcedureFileUploadCompleteReq() {
		this.header.setMsgType(Commands.PROCEDURE_FILE_UPLOAD_OK_REQ);
	}

	public ProcedureFileUploadCompleteReq(byte[] data) {
		super(data);
	}
	...
	public String toString() {
		return "ProcedureFileUploadCompleteReq [sessionID=" + sessionID
